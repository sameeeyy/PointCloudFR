...
class DependencyInstaller:
    ...
    def prompt_installation(self, missing_packages):
        ...
        message = f"The following Python packages are required for {self.plugin_name}:\n\n"
    ...
    def _install_package(self, package):
        ...
        methods = [
            ...
            lambda: os.system(f'"{os.path.join(sys.prefix, "scripts", "pip")}" install {package}'),
        ...
        try:
            ...
            for package in missing:
                if not self._install_package(package):
                    QgsMessageLog.logMessage(f"Failed to install {package}", self.plugin_name, Qgis.Critical)
                    return False
    ...
    def verify_batch_files(self):
        ...
        return (self.py3_env_path.exists() and
                self.install_script_path.exists() and
    ...
    def install(self):
        ...
        try:
            ...
            QgsMessageLog.logMessage("Successfully installed all dependencies", self.plugin_name, Qgis.Success)
            return True

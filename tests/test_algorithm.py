...
class TestAlgorithmGeometryCollection:
    ...
    def test_collect_valid_geometries(self, mock_qgs_geometry_class, mock_logger, mock_feedback):
    ...
    @patch("PointCloudFR.lidar_algorithm.QgsGeometry")
    def test_collect_with_transform(self, mock_qgs_geometry_class, mock_logger, mock_feedback):
        from PointCloudFR.lidar_algorithm import LidarDownloaderAlgorithm
